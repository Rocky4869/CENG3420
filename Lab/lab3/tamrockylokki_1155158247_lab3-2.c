...
void cycle_memory() {
    ...
    if (mio_en) {
        ...
        if (W) {
             ...
             * Lab3-2 assignment
             */
            printf("Lab3-2 assignment: write to the main memory");
            write_memory(datasize_mux(get_DATASIZE(CURRENT_LATCHES.MICROINSTRUCTION),mask_val(CURRENT_LATCHES.IR,14,12),0),
                         CURRENT_LATCHES.MAR,
                         CURRENT_LATCHES.MDR) ;
        } else {
            /* read */
             ...
             */
            printf("Lab3-2 assignment: read from the main memory");
            if(get_LD_PC(CURRENT_LATCHES.MICROINSTRUCTION)==0)MEM_VAL = read_memory(datasize_mux(get_DATASIZE(CURRENT_LATCHES.MICROINSTRUCTION),
...
void latch_datapath_values() {
    ...
    if (get_LD_REG(CURRENT_LATCHES.MICROINSTRUCTION)) {
         ...
         *  Lab3-2 assignment
         */
        printf("Lab3-2 assignment: handle LD_REG");
    ...
    if (get_LD_MAR(CURRENT_LATCHES.MICROINSTRUCTION)) {
         ...
         *  Lab3-2 assignment
         */
        printf("Lab3-2 assignment: handle LD_MAR");
    ...
    if (get_LD_IR(CURRENT_LATCHES.MICROINSTRUCTION)) {
         ...
         *  Lab3-2 assignment
         */
        printf("Lab3-2 assignment: handle LD_IR");
        NEXT_LATCHES.IR = BUS;
    }
    /* LD.PC */
    if (get_LD_PC(CURRENT_LATCHES.MICROINSTRUCTION)) {
         ...
         *  Lab3-2 assignment
         */
        printf("Lab3-2 assignment: handle LD_PC");
